      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-display font-bold">Classic Cuts</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-primary-400 mt-1 mr-3"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@classiccuts.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 py-8 text-center text-gray-400">
          <p>&copy; {currentYear} Classic Cuts. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
